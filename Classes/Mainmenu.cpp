...
bool MainMenu::init()
{
	...
	*/
	...
	Highscore = Label::createWithTTF("HIGHSCORE", "fonts/Marker Felt.ttf", 24);
	Highscore->setPosition(Vec2(playingSize.width * 0.5f, 0 + GameTitle->getContentSize().height * 5));
...
void MainMenu::onKeyReleased(EventKeyboard::KeyCode keyCode, Event * event)
{
	...
	if (keyCode == EventKeyboard::KeyCode::KEY_DOWN_ARROW)
	{
		...
		{
		case PLAY:
			arrow->setPosition(Vec2(playingSize.width * 0.35f, playingSize.height * HIGHSCORE_POSITION));
			selection = HIGHSCORE;
			break;
		case HIGHSCORE:
	...
	if (keyCode == EventKeyboard::KeyCode::KEY_UP_ARROW)
	{
		...
		case PLAY:
			break;
		case HIGHSCORE:
			arrow->setPosition(Vec2(playingSize.width * 0.35f, playingSize.height * PLAY_POSITION));
			selection = PLAY;
			break;
		case TUTORIAL:
			arrow->setPosition(Vec2(playingSize.width * 0.35f, playingSize.height * HIGHSCORE_POSITION));
